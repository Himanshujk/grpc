...
var file_chatpb_chat_proto_rawDesc = []byte{
	...
	,
...
var file_chatpb_chat_proto_depIdxs = []int32{
	...
	0, // 1: chatpb.ChatService.Connected:input_type -> chatpb.Channel
	0, // 2: chatpb.ChatService.JoinChannel:input_type -> chatpb.Channel
	1, // 3: chatpb.ChatService.SendMessage:input_type -> chatpb.Message
	1, // 4: chatpb.ChatService.SendMessagetoEveryone:input_type -> chatpb.Message
	2, // 5: chatpb.ChatService.Connected:output_type -> chatpb.MessageAck
	1, // 6: chatpb.ChatService.JoinChannel:output_type -> chatpb.Message
	2, // 7: chatpb.ChatService.SendMessage:output_type -> chatpb.MessageAck
	1, // 8: chatpb.ChatService.SendMessagetoEveryone:output_type -> chatpb.Message
